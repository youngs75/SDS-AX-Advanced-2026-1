...
기본 기능 (기존):
    from src.observability.langfuse import enabled, client
...
트레이스 강화 (신규) — 두 가지 방식 지원:
    ...
    방법 1 - propagate_attributes 래핑 (권장, Langfuse v3):
        ...
        from src.observability.langfuse import enrich_trace
    ...
    스코어링 (다중 데이터 타입):
        ...
        from src.observability.langfuse import score_trace
