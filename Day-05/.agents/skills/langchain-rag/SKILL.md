...
- [ ] Vector store chosen and connection verified?
- [ ] Retriever returning relevant results (manual spot-check)?
- [ ] Metadata filtering working correctly?
- [ ] RAG chain producing grounded answers (not hallucinating)?
- [ ] Token limits respected (context window not exceeded)?
- [ ] Retrieval latency acceptable for use case?
