"""Public package entrypoints for `deepagents-cli`.

This module keeps package import side effects small by exposing lightweight
metadata eagerly and loading the full CLI bootstrap only when `cli_main` is
requested.
"""
