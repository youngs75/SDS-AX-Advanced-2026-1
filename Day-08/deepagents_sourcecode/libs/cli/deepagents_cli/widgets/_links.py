"""Handle safe link activation inside Textual widgets.

Textual intercepts clicks before terminal hyperlink escape sequences can fire,
so this module recreates single-click link behavior while applying URL safety
checks first.
"""
