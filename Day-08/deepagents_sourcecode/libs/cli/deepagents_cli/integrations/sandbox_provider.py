"""Provider interfaces and shared errors for sandbox integrations.

Concrete providers implement this contract so CLI code can provision, resume,
and delete sandboxes without depending on any one vendor SDK directly.
"""
